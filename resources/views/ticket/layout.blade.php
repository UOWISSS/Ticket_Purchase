...
<html lang="hu">
    <head>
        ...
        <title>Ticket | @yield('title', 'Események')</title>
        <link
    ...
    <body>
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container-fluid mx-5">
                <a class="navbar-brand" href="{{ route('events.index') }}">Ticket</a>
                <button
                        ...
                        @else
                            <div class="nav-item dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="userMenu">
                                    <li>
                                        <a class="dropdown-item" href="{{ route('tickets.my') }}">Jegyeim</a>
                                    </li>
                                    ...
                                    @auth
                                         @if(auth()->user()->admin)
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('admin.events.create') }}">Esemény létrehozása</a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link" href="{{ route('admin.seats.index') }}">Ülőhelyek</a>
                                            </li>
                                        @endif
                                    @endauth
